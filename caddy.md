...
<i>This isn't about Drummer per se, but would be a possible path for Drummer itself to run under HTTPS</i>
...
1. Install the official Caddy package for Ubuntu <a href="https://caddyserver.com/docs/install#debian-ubuntu-raspbian">per their instructions</a>.  This automatically starts and runs Caddy as a systemd service.
